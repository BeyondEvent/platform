  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-active:bg-background/80 backdrop-blur-sm data-active:text-foreground dark:data-active:border-input dark:data-active:bg-background/40 dark:data-active:text-foreground',
